<template>
    <div :class="$style['danger-container']">
        <svg t="1729152504346" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="10625" width="1em" height="1em">
            <path
